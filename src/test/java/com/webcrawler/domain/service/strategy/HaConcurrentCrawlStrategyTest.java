...
public class HaConcurrentCrawlStrategyTest {
    ...
    private final CrawlStrategy strategy =
            new HaConcurrentCrawlStrategy(processor, reporter, 10, Integer.MAX_VALUE, HaConcurrentBfsFrontier::new);
    ...
    void shouldStopAfterMaxPagesReached() {
        ...
        var limited = new HaConcurrentCrawlStrategy(processor, reporter, 10, 1, HaConcurrentBfsFrontier::new);
